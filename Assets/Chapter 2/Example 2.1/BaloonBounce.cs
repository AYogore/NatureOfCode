...
public class BaloonBounce : MonoBehaviour
{
    ...
    void Start()
    {
        mover = new Baloon(moverSpawnTransform.position, leftWallX, rightWallX, floorY, topY);
...
public class Baloon
{
    ...
    public Baloon(Vector3 position, float xMin, float xMax, float yMin, float yMax)
    {
        this.xMin = xMin;
        this.xMax = xMax;
        this.yMin = yMin;
